...
<html lang="en-US" class="no-js">
  <head>
    ...
    <title>{{headTitle|default("PFWsense") }} | {{system_hostname}}.{{system_domain}}</title>
    {% set theme_name = ui_theme|default('pfwsense') %}
      ...
      <div class="container-fluid">
        <div class="navbar-header">
          <a class="navbar-brand" href="/">
            {% if file_exists(["/usr/local/pfwsense/www/themes/",theme_name,"/build/images/default-logo.svg"]|join("")) %}
            ...
            {% endif %}
            {% if file_exists(["/usr/local/pfwsense/www/themes/",theme_name,"/build/images/icon-logo.svg"]|join("")) %}
  ...
  <main class="page-content col-sm-9 col-sm-push-3 col-lg-10 col-lg-push-2">
    ...
    <div class="modal fade" id="PFWsenseStdWaitDialog" tabindex="-1" data-backdrop="static" data-keyboard="false">
